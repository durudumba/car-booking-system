...
const carInfoColumns = [
    { header : '차량번호', name : 'carNumber', sortable: true, resizeable: true, width: 150, align: 'center'},
    { header : '차량모델', name : 'carModel', sortable: true, resizeable: true, width: 120, align: 'center'},
    { header : '연료타입', name : 'fuelType', sortable: true, resizeable: true, width: 80, align: 'center'},
    { header : '차량상태', name : 'carStts', sortable: true, resizeable: true, width: 100, align: 'center'},
    { header : '주차위치', name : 'parkLocation', sortable: true, resizeable: true, width: 120, align: 'center', formatter: emptyCellFormatter},
